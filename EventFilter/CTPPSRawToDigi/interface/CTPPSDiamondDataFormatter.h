#ifndef CTPPS_CTPPSRawToDigi_CTPPSDiamondDataFormatter_h
#define CTPPS_CTPPSRawToDigi_CTPPSDiamondDataFormatter_h
/** \class CTPPSDiamondDataFormatter
 *
 *  Transform CTPPSDiamond raw data of a given  FED to digi
 *  
 *
...
public:
  ...
  typedef edm::DetSetVector<CTPPSDiamondDigi> Collection;

  typedef std::map<int, FEDRawData> RawData;
  typedef std::vector<CTPPSDiamondDigi> DetDigis;
