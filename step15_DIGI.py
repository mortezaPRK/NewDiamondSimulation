...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step15_DIGI.root'),
    outputCommands = process.FEVTDEBUGEventContent.outputCommands + ['keep *_RP*_*_*','keep *_LHCTransport_*_*'],
...
# Schedule definition
process.schedule = cms.Schedule(process.mixedigi_step,process.endjob_step,process.FEVTDEBUGoutput_step)
