#ifndef SimCTPPS_CTPPSDiamondDigiProducer_ENERGY_DEPOSIT_UNIT_H
#define SimCTPPS_CTPPSDiamondDigiProducer_ENERGY_DEPOSIT_UNIT_H
...
{
public:
  RDimEnergyDepositUnit() : _energy(0), _position(0, 0, 0) {}
  RDimEnergyDepositUnit(double energy, double x, double y, double z) : _energy(energy), _position(x, y, z) {}
  RDimEnergyDepositUnit(double energy, const Local3DPoint &position) : _energy(energy), _position(position) {}
