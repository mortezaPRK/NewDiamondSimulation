#ifndef SimCTPPS_CTPPSDiamondDigiProducer_RDim_LINEAR_CHARGE_COLLECTION_DRIFTER_H
#define SimCTPPS_CTPPSDiamondDigiProducer_RDim_LINEAR_CHARGE_COLLECTION_DRIFTER_H
...
private:
  std::vector<RDimSignalPoint> _temp;
