#ifndef SimCTPPS_CTPPSDiamondDigiProducer_RDim_SignalPoint_H
#define SimCTPPS_CTPPSDiamondDigiProducer_RDim_SignalPoint_H
 ...
 */
class RDimSignalPoint {
  public:
    RDimSignalPoint() : pos_(0,0), sigma_(0), charge_(0) {}
    
    RDimSignalPoint(double x, double y, double s, double charge) : 
